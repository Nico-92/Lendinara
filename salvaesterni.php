...
$altroesterni=$_POST['altroesterni'];
...
$a=$array['id'];
$query3 = "INSERT INTO esterni (id, tessera, datatessera, licenza, datalicenza, procuratore, altro ) VALUES ('$a', '$tessera', '$datatessera', '$licenza', '$datalicenza', '$procuratore', '$altroesterni')";
...
$query3 = "INSERT INTO motorclub (id, tessera, datatessera, importotessera, licenza, datalicenza, importolicenza, tesserasport, datasport, importosport) VALUES ('$a', '', '', '','', '', '', '', '', '')";
$result2=mysql_query($query3, $conn) or die('Error, insert query failed' . mysql_error());
