...
<div align="center">
<a href="gara.php"><input type="button" value="Pannello di controllo" class="btn btn-default unstamp" /></a>
<a href="riassuntoeventi.php"><input type="button" value="Riassunto Eventi" class="btn btn-default unstamp" /></a>
<a href="riassuntoiscritti.php?on=1"><input type="button" value="Elenco tesserati" class="btn btn-default unstamp" /></a>
			...
			<table border="1">
				<tr><td>
					<form name="evento" method="GET">
						<table class="table">
							...
							<tr><td>Costo</td><td><input type="text" ng-model="datievento.costo" class="input-small" disabled/></td></tr>
							<tr><td>Data</td><td><input type="text" ng-model="datievento.data" class="input-small" disabled /></td></tr>
							<tr><td>Luogo</td><td><input type="text" ng-model="datievento.luogo" class="input-small" disabled /></td></tr>
							<tr><td>Altro</td><td><input type="text" ng-model="datievento.altro" class="input-small" disabled /></td></tr>
							<tr><td colspan="2"><a href="gara.php" class="unstamp"><button type="button" class="btn btn-link unstamp" tooltip="Clicca per andare alla pagina di modifica evento"  tooltip-trigger="mouseenter" tooltip-placement="right">Modifica evento</button></a></td></tr>
							<tr><td colspan="2"><a href="stampa_iscritti.php?evento={{selezionaEvento.nome}}" class="unstamp" target="_blank"><button type="button" class="btn btn-link unstamp" ng-if="selezionaEvento"  >Stampa lista iscritti evento</button></a></td></tr>
						</table>
					</form>
				</td>
				<td>
				...
				<tabset justified="true" >
			    	<tab heading="Dati Persona" select="active()">
			    		...
			    		<table class="table">
							<tr><td>Nome</td><td><input type="text" ng-model="iscritto.nome" placeholder="Nome e cognome" typeahead="nome for nome in getIscritti($viewValue) | filter:$viewValue | limitTo:4" ng-blur="checkTessera(iscritto.nome)" />
							...
							<tr><td colspan="2"><button type="submit" class="btn btn-success unstamp" ng-if="selezionaEvento" ng-click="iscrivi(iscritto)" >Iscrivi a {{selezionaEvento.nome}}</button>
		        ...
		        <table>
		        	...
		        	<tr><td><input type="text" id="grandeNumero" ng-model="grandeNumero" class="input-small unstamp" ng-change="checkNumero();" required />
		...
		<form name="nuovaIscrizione" id="nuovaIscrizione">
			<table class="table larger-font">
				...
				<tr>
					...
					<td>Varie</td><td colspan="3" ><input type="text" placeholder="Varie" ng-model="iscritto.varie" class="input-xxlarge"/></td>
				</tr>
			</table>
