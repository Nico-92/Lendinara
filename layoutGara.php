	...
	<div ng-controller="layoutStampaController">
		<div  class="layoutStampa">
			...
			<div class="blocco blocco-dati text-center">
				Qui verranno visualizzati i dati del concorrente
			</div>
		...
		<div class="control-panel unstamp">
			<h1><small>Layout di stampa iscrizione gara</small></h1>
			<p>A sinistra puoi vedere come sarà la stampa lanciata quando un concorrente viene iscritto ad una gara.
